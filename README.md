...
- `media/tekan-buddy-ad-web.mp4` — the promo video, re-encoded for the web (H.264, 960x960, ~5 MB).
- `media/tekan-buddy-ad-poster.jpg` — poster frame shown before the video plays.
...
```sh
ffmpeg -i promo-master.mp4 -c:v libx264 -preset slow -crf 23 -pix_fmt yuv420p -movflags +faststart -c:a aac -b:a 128k media/tekan-buddy-ad-web.mp4
ffmpeg -ss 1.5 -i promo-master.mp4 -frames:v 1 -q:v 3 media/tekan-buddy-ad-poster.jpg
```
